...
return [
    ...
    */
    ...
    'googlemaps' => [
        'key'    => env('GOOGLE_MAPS_KEY', 'AIzaSyASSOI-RvL8mXxWyZUE6ntElrRgMMag_to'),
        'center' => [
            'lat' => env('GOOGLE_MAPS_DEFAULT_CENTER_LAT', '43.2311871'),
            'lng' => env('GOOGLE_MAPS_DEFAULT_CENTER_LNG', '76.8934238'),
        ],
